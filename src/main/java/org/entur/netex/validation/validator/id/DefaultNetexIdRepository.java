...
public class DefaultNetexIdRepository implements NetexIdRepository {
    ...
    @Override
    public synchronized Set<String> getDuplicateNetexIds(String reportId, String filename, Set<String> localIds) {
    ...
    @Override
    public synchronized void addSharedNetexIds(String reportId, Set<IdVersion> commonIdVersions) {
