...
public class ValidationReport {
  ...
  public ValidationReport(
    ...
    this.creationDate = LocalDateTime.now();
    this.validationReportEntries = new ArrayList<>(validationReportEntries);
    this.numberOfValidationEntriesPerRule =
      new HashMap<>(numberOfValidationEntriesPerRule);
  }
  ...
  public void addAllValidationReportEntries(
    Collection<ValidationReportEntry> validationReportEntries
  ) {
  ...
  private void addValidationReportEntryToMap(
    ValidationReportEntry validationReportEntry
  ) {
    numberOfValidationEntriesPerRule.merge(
