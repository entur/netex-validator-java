...
public final class NetexIdExtractorHelper {
   ...
   */
  public static List<IdVersion> collectEntityIdentifiers(
    XdmNode document,
    XPathCompiler xPathCompiler,
    String filename,
    Set<String> ignorableElementNames
  ) {
    return collectIdOrRefWithVersion(
      document,
      xPathCompiler,
      filename,
      "id",
      ignorableElementNames
    );
  }
   ...
   */
  public static List<IdVersion> collectEntityReferences(
    XdmNode document,
    XPathCompiler xPathCompiler,
    String filename,
    Set<String> ignorableElementNames
  ...
  private static List<IdVersion> collectIdOrRefWithVersion(
    XdmNode document,
    XPathCompiler xPathCompiler,
    String filename,
    ...
    try {
      ...
      throw new NetexValidationException(
        "Exception while parsing the NeTEx file " + filename,
        e
      );
    }
