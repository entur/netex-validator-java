...
public class DefaultValidationTreeFactory implements ValidationTreeFactory {
    ...
    public ValidationTree buildValidationTree() {
        ...
        validationTree.addValidationRule(new ValidateNotExist("PublicationDelivery//*[@version != 'any' and number(@version) != number(@version)]", "Non-numeric NeTEx version", "VERSION_NON_NUMERIC"));
    ...
    protected ValidationTree getSingleFramesValidationTreeForCommonFile() {
        ...
        validationTree.addValidationRule(new ValidateNotExist("ResourceFrame[not(validityConditions) and count(//ResourceFrame) > 1]", "Multiple ResourceFrames without validity conditions", "VALIDITY_CONDITIONS_IN_COMMON_FILE_2"));
        validationTree.addValidationRule(new ValidateNotExist("ServiceFrame[not(validityConditions) and count(//ServiceFrame) > 1]", "Multiple ServiceFrames without validity conditions", "VALIDITY_CONDITIONS_IN_COMMON_FILE_3"));
    ...
    protected ValidationTree getSingleFramesValidationTreeForLineFile() {
        ...
        validationTree.addValidationRule(new ValidateNotExist("ServiceFrame[not(validityConditions) and count(//ServiceFrame) > 1]", "Multiple frames of same type without validity conditions", "VALIDITY_CONDITIONS_IN_LINE_FILE_2"));
        validationTree.addValidationRule(new ValidateNotExist("ServiceCalendarFrame[not(validityConditions) and count(//ServiceCalendarFrame) > 1]", "Multiple frames of same type without validity conditions", "VALIDITY_CONDITIONS_IN_LINE_FILE_3"));
        validationTree.addValidationRule(new ValidateNotExist("TimetableFrame[not(validityConditions) and count(//TimetableFrame) > 1]", "Multiple frames of same type without validity conditions", "VALIDITY_CONDITIONS_IN_LINE_FILE_4"));
    ...
    protected ValidationTree getTimetableFrameValidationTree(String path) {
        ...
        validationTree.addValidationRule(new ValidateAtLeastOne("vehicleJourneys/ServiceJourney", "There should be at least one ServiceJourney", "SERVICE_JOURNEY_1"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney/calls", "Element Call not allowed", "SERVICE_JOURNEY_2"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[not(passingTimes)]", "The ServiceJourney does not specify any TimetabledPassingTimes", "SERVICE_JOURNEY_3"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney/passingTimes/TimetabledPassingTime[not(DepartureTime or EarliestDepartureTime) and not(ArrivalTime or LatestArrivalTime)]", "TimetabledPassingTime contains neither DepartureTime/EarliestDepartureTime nor ArrivalTime/LatestArrivalTime", "SERVICE_JOURNEY_4"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[not(passingTimes/TimetabledPassingTime[1]/DepartureTime) and not(passingTimes/TimetabledPassingTime[1]/EarliestDepartureTime)]", "All TimetabledPassingTime except last call must have DepartureTime", "SERVICE_JOURNEY_5"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[count(passingTimes/TimetabledPassingTime[last()]/ArrivalTime) = 0 and count(passingTimes/TimetabledPassingTime[last()]/LatestArrivalTime) = 0]", "Last TimetabledPassingTime must have ArrivalTime", "SERVICE_JOURNEY_6"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney/passingTimes/TimetabledPassingTime[DepartureTime = ArrivalTime]", "ArrivalTime is identical to DepartureTime", "SERVICE_JOURNEY_7"));
        ...
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[not(OperatorRef) and not(//ServiceFrame/lines/*[self::Line or self::FlexibleLine]/OperatorRef)]", "Missing OperatorRef on ServiceJourney (not defined on Line)", "SERVICE_JOURNEY_12"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[not(dayTypes/DayTypeRef) and not(@id=//TimetableFrame/vehicleJourneys/DatedServiceJourney/ServiceJourneyRef/@ref)]", "The ServiceJourney does not refer to DayTypes nor DatedServiceJourneys", "SERVICE_JOURNEY_13"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[dayTypes/DayTypeRef and @id=//TimetableFrame/vehicleJourneys/DatedServiceJourney/ServiceJourneyRef/@ref]", "The ServiceJourney references both DayTypes and DatedServiceJourneys", "SERVICE_JOURNEY_14"));
        ...
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[@id = preceding-sibling::ServiceJourney/@id]", "ServiceJourney is repeated with a different version", "SERVICE_JOURNEY_16"));

        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/DatedServiceJourney[not(OperatingDayRef)]", "Missing OperatingDayRef on DatedServiceJourney", "DATED_SERVICE_JOURNEY_1"));
        ...
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/DeadRun[not(dayTypes/DayTypeRef)]", "The Dead run does not reference day types", "DEAD_RUN_3"));

        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney/FlexibleServiceProperties[not(@id)]", "Missing id on FlexibleServiceProperties", "FLEXIBLE_SERVICE_1"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney/FlexibleServiceProperties[not(@version)]", "Missing version on FlexibleServiceProperties", "FLEXIBLE_SERVICE_2"));
    ...
    protected List<ValidationRule> getCompositeFrameBaseValidationRules() {
        ...
        validationRules.add(new ValidateNotExist("frames/SiteFrame", "Unexpected element SiteFrame. It will be ignored", "COMPOSITE_SITE_FRAME_IN_COMMON_FILE"));

        validationRules.add(new ValidateNotExist(".[not(validityConditions)]", "A CompositeFrame must define a ValidityCondition valid for all data within the CompositeFrame", "COMPOSITE_FRAME_1"));
        validationRules.add(new ValidateNotExist("frames//validityConditions", "ValidityConditions defined inside a frame inside a CompositeFrame", "COMPOSITE_FRAME_2"));

        validationRules.add(new ValidateNotExist("//ValidBetween[not(FromDate) and not(ToDate)]", "ValidBetween missing either or both of FromDate/ToDate", "COMPOSITE_FRAME_3"));
        validationRules.add(new ValidateNotExist("//ValidBetween[FromDate and ToDate and ToDate < FromDate]", "FromDate cannot be after ToDate on ValidBetween", "COMPOSITE_FRAME_4"));

        validationRules.add(new ValidateNotExist("//AvailabilityCondition[not(FromDate) and not(ToDate)]", "AvailabilityCondition must have either FromDate or ToDate or both present", "COMPOSITE_FRAME_4"));
        validationRules.add(new ValidateNotExist("//AvailabilityCondition[FromDate and ToDate and ToDate < FromDate]", "FromDate cannot be after ToDate on AvailabilityCondition", "COMPOSITE_FRAME_5"));
    ...
    protected ValidationTree getResourceFrameValidationTree(String path) {
        ...
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Operator[not(CompanyNumber) or normalize-space(CompanyNumber) = '']", "Missing CompanyNumber element on Operator", "OPERATOR_1"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Operator[not(Name) or normalize-space(Name) = '']", "Missing Name on Operator", "OPERATOR_2"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Operator[not(LegalName) or normalize-space(LegalName) = '']", "Missing LegalName element on Operator", "OPERATOR_3"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Operator[not(ContactDetails)]", "Missing ContactDetails element on Operator", "OPERATOR_4"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Operator/ContactDetails[(not(Email) or normalize-space(Email) = '') and (not(Phone) or normalize-space(Phone) = '') and (not(Url) or normalize-space(Url) = '')]", "At least one of Url, Phone or Email must be defined for ContactDetails on Operator", "OPERATOR_5"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Operator[not(CustomerServiceContactDetails)]", "Missing CustomerServiceContactDetails element on Operator", "OPERATOR_6"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Operator/CustomerServiceContactDetails[not(Url) or normalize-space(Url) = '']", "Missing Url element for CustomerServiceContactDetails on Operator", "OPERATOR_7"));

        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Authority[not(CompanyNumber) or normalize-space(CompanyNumber) = '']", "Missing CompanyNumber element on Authority", "AUTHORITY_1"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Authority[not(Name) or normalize-space(Name) = '']", "Missing Name element on Authority", "AUTHORITY_2"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Authority[not(LegalName) or normalize-space(LegalName) = '']", "Missing LegalName element on Authority", "AUTHORITY_3"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Authority[not(ContactDetails)]", "Missing ContactDetails on Authority", "AUTHORITY_4"));
        resourceFrameValidationTree.addValidationRule(new ValidateNotExist("organisations/Authority/ContactDetails[not(Url) or not(starts-with(Url, 'http://') or (starts-with(Url, 'https://')) )]", "The Url must be defined for ContactDetails on Authority and it must start with 'http://' or 'https://'", "AUTHORITY_5"));
    ...
    protected ValidationTree getServiceCalendarFrameValidationTree(String path) {
        ...
        serviceCalendarFrameValidationTree.addValidationRule(new ValidateNotExist("//DayType[not(//DayTypeAssignment/DayTypeRef/@ref = @id)]", "The DayType is not assigned to any calendar dates or periods", "SERVICE_CALENDAR_1"));
        serviceCalendarFrameValidationTree.addValidationRule(new ValidateNotExist("//ServiceCalendar[not(dayTypes) and not(dayTypeAssignments)]", "ServiceCalendar does not contain neither DayTypes nor DayTypeAssignments", "SERVICE_CALENDAR_2"));
        serviceCalendarFrameValidationTree.addValidationRule(new ValidateNotExist("//ServiceCalendar[not(ToDate)]", "Missing ToDate on ServiceCalendar", "SERVICE_CALENDAR_3"));
        serviceCalendarFrameValidationTree.addValidationRule(new ValidateNotExist("//ServiceCalendar[not(FromDate)]", "Missing FromDate on ServiceCalendar", "SERVICE_CALENDAR_4"));
        serviceCalendarFrameValidationTree.addValidationRule(new ValidateNotExist("//ServiceCalendar[FromDate and ToDate and ToDate < FromDate]", "FromDate cannot be after ToDate on ServiceCalendar", "SERVICE_CALENDAR_5"));
    ...
    protected List<ValidationRule> getServiceFrameBaseValidationRules() {
        List<ValidationRule> validationRules = new ArrayList<>();
        validationRules.add(new ValidateNotExist("Network[not(AuthorityRef)]", "Missing AuthorityRef on Network", "NETWORK_1"));
        validationRules.add(new ValidateNotExist("Network[not(Name) or normalize-space(Name) = '']", "Missing Name element on Network", "NETWORK_2"));
        validationRules.add(new ValidateNotExist("Network/groupsOfLines/GroupOfLines[not(Name)  or normalize-space(Name) = '']", "Missing Name element on GroupOfLines", "NETWORK_3"));
        validationRules.add(new ValidateNotExist("groupsOfLines", "Unexpected element groupsOfLines outside of Network", "SERVICE_FRAME_1"));
        validationRules.add(new ValidateNotExist("timingPoints", "Unexpected element timingPoints. Content ignored", "SERVICE_FRAME_2"));
        validationRules.add(new ValidateNotExist("routePoints/RoutePoint[not(projections)]", "Missing Projection on RoutePoint", "SERVICE_FRAME_3"));

        validationRules.add(new ValidateNotExist("stopAssignments/PassengerStopAssignment[not(ScheduledStopPointRef)]", "Missing ScheduledStopPointRef on PassengerStopAssignment", "PASSENGER_STOP_ASSIGNMENT_1"));
        validationRules.add(new ValidateNotExist("stopAssignments/PassengerStopAssignment[not(QuayRef)]", "Missing QuayRef on PassengerStopAssignment", "PASSENGER_STOP_ASSIGNMENT_2"));
        validationRules.add(new ValidateNotExist("stopAssignments/PassengerStopAssignment[QuayRef/@ref = following-sibling::PassengerStopAssignment/QuayRef/@ref]", "The same quay is assigned more than once in PassengerStopAssignments", "PASSENGER_STOP_ASSIGNMENT_3"));

        validationRules.add(new ValidateNotExist("serviceLinks/ServiceLink[not(FromPointRef)]", "Missing FromPointRef on ServiceLink", "SERVICE_LINK_1"));
        validationRules.add(new ValidateNotExist("serviceLinks/ServiceLink[not(ToPointRef)]", "Missing ToPointRef on ServiceLink", "SERVICE_LINK_2"));
        validationRules.add(new ValidateNotExist("serviceLinks/ServiceLink/projections/LinkSequenceProjection/g:LineString/g:posList[not(normalize-space(text()))]", "Missing projections element on ServiceLink", "SERVICE_LINK_3"));

        validationRules.add((new ValidateNotExist("destinationDisplays/DestinationDisplay[not(FrontText) or normalize-space(FrontText) = '']", "Missing FrontText on DestinationDisplay", "DESTINATION_DISPLAY_1")));
        validationRules.add((new ValidateNotExist("destinationDisplays/DestinationDisplay/vias/Via[not(DestinationDisplayRef)]", "Missing DestinationDisplayRef on Via", "DESTINATION_DISPLAY_2")));
    ...
    protected ValidationTree getNoticesValidationTree() {
        ...
        noticesValidationTree.addValidationRule(new ValidateNotExist("Notice[not(Text) or normalize-space(Text/text()) = '']", "Missing element Text for Notice", "NOTICE_1"));
        noticesValidationTree.addValidationRule(new ValidateNotExist("Notice/alternativeTexts/AlternativeText[not(Text) or normalize-space(Text/text()) = '']", "Missing or empty element Text for Notice Alternative Text", "NOTICE_2"));
        noticesValidationTree.addValidationRule(new ValidateNotExist("Notice/alternativeTexts/AlternativeText/Text[not(@lang)]", "Missing element Lang for Notice Alternative Text", "NOTICE_3"));
        noticesValidationTree.addValidationRule(new ValidateNotExist("Notice/alternativeTexts/AlternativeText[Text/@lang = following-sibling::AlternativeText/Text/@lang or Text/@lang = preceding-sibling::AlternativeText/Text/@lang]", "The Notice has two Alternative Texts with the same language", "NOTICE_4"));
