...
public class DefaultValidationTreeFactory implements ValidationTreeFactory {
    ...
    protected ValidationTree getServiceFrameValidationTreeForLineFile(String path) {
        ...
        serviceFrameValidationTree.addValidationRule(new ValidateNotExist("journeyPatterns/JourneyPattern/pointsInSequence/StopPointInJourneyPattern[last()][DestinationDisplayRef]", "DestinationDisplayRef not allowed on last StopPointInJourneyPattern", "JOURNEY_PATTERN_5", ValidationReportEntrySeverity.WARNING));
