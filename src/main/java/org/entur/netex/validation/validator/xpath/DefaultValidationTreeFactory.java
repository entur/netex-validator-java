...
public class DefaultValidationTreeFactory implements ValidationTreeFactory {
    ...
    protected ValidationTree getTimetableFrameValidationTree(String path) {
        ...
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney/passingTimes/TimetabledPassingTime[not(DepartureTime) and not(ArrivalTime)]", "TimetabledPassingTime contains neither DepartureTime nor ArrivalTime", "SERVICE_JOURNEY_4"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[not(passingTimes/TimetabledPassingTime[1]/DepartureTime)]", "All TimetabledPassingTime except last call must have DepartureTime", "SERVICE_JOURNEY_5"));
        validationTree.addValidationRule(new ValidateNotExist("vehicleJourneys/ServiceJourney[count(passingTimes/TimetabledPassingTime[last()]/ArrivalTime) = 0]", "Last TimetabledPassingTime must have ArrivalTime", "SERVICE_JOURNEY_6"));
